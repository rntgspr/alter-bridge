...
|---|---|---|---|
| T1 | `session.ClaudeBin` + `nudge.RingClaude`: detached throwaway Claude ring with exact-path transcript cleanup | — | pending |
| T2 | `relay` subcommand: log, gates, notice, per-provider ring, wiring | T1 | pending |
